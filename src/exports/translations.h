...
constexpr std::string_view correlationNone{ "No correlations found! This can be caused by having too little data "
                                            "measurements (<10)" };
...
{
const inline std::string errorExportType{ "Export type unknown! Supported export types are: " };
}