...
std::string ArgToString(const Args&... args)
{
...
std::string GetString(const DataType& data)
{
  std::ostringstream ss;
  ss << data;
  return ss.str();
...
std::vector<VectorType> CombineVectors(const std::vector<VectorType>& a, const std::vector<VectorType>& b)
{
