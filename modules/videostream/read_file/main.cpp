...
void print_help()
{
  std::string helpStr = "Execute this program with superuser access and with "
                        "the following parameters:"
                        "./<Program Name><SharedMemInput><SharedMemOutput>"
                        "<SharedMemInput> The address of the shared memory "
                        "that is used for the input"
                        "<SharedMemOutput>: The address of the shared memory "
